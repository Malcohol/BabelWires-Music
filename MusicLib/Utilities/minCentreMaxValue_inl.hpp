...
inline bw_music::MinCentreMaxValueT<STORAGE_TYPE>::MinCentreMaxValueT(STORAGE_TYPE value)
    : m_value(value) {}
...
bw_music::MinCentreMaxValueT<STORAGE_TYPE>::tryFromUnsigned(UnsignedInt value) {
    ...
    if constexpr (numSourceBits < 64) {
        if (value >= (static_cast<std::uint64_t>(1) << numSourceBits)) {
            return MinCentreMaxValueT(std::numeric_limits<STORAGE_TYPE>::max());
        }
    }
    return MinCentreMaxValueT(
        bw_music::detail::minCentreMaxScale<numSourceBits, c_storageBits, STORAGE_TYPE>(static_cast<std::uint64_t>(value)));
...
template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
inline std::uint8_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getUnsigned8() const {
    return bw_music::detail::minCentreMaxScale<STORAGE_TYPE, std::uint8_t>(m_value);
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
inline std::uint16_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getUnsigned16() const {
    return bw_music::detail::minCentreMaxScale<STORAGE_TYPE, std::uint16_t>(m_value);
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
inline std::uint32_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getUnsigned32() const {
    return bw_music::detail::minCentreMaxScale<STORAGE_TYPE, std::uint32_t>(m_value);
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
inline std::uint64_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getUnsigned64() const {
    return bw_music::detail::minCentreMaxScale<STORAGE_TYPE, std::uint64_t>(m_value);
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
template <std::uint8_t numSourceBits>
std::uint64_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getUnsigned() const {
    static_assert(numSourceBits <= 64, "numSourceBits must be less than or equal to 64");
    return bw_music::detail::minCentreMaxScale<c_storageBits, numSourceBits, std::uint64_t>(m_value);
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
inline bw_music::MinCentreMaxValueT<STORAGE_TYPE>
bw_music::MinCentreMaxValueT<STORAGE_TYPE>::assertFromSignedNormalizedDouble(double signedNormalizedValue) {
    ...
    if (signedNormalizedValue < 0.0) {
        return MinCentreMaxValueT(static_cast<STORAGE_TYPE>(centre * (1.0L + signedNormalizedValue)));
    } else {
        return MinCentreMaxValueT(static_cast<STORAGE_TYPE>(centre + ((centre - 1.0L) * signedNormalizedValue)));
    }
}

template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
babelwires::ResultT<bw_music::MinCentreMaxValueT<STORAGE_TYPE>>
bw_music::MinCentreMaxValueT<STORAGE_TYPE>::fromSignedNormalizedDouble(double signedNormalizedValue) {
...
template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
bw_music::MinCentreMaxValueT<STORAGE_TYPE>
bw_music::MinCentreMaxValueT<STORAGE_TYPE>::tryFromSignedNormalizedDouble(double signedNormalizedValue) {
    if (signedNormalizedValue < -1.0) {
        return MinCentreMaxValueT(0u);
...
template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
double bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getSignedNormalizedValue() const {
    constexpr std::uint64_t centreValue = (static_cast<std::uint64_t>(1) << (c_storageBits - 1));
    constexpr long double centre = static_cast<long double>(centreValue);
...
template <bw_music::MinCentreMaxValueStorageType STORAGE_TYPE>
std::size_t bw_music::MinCentreMaxValueT<STORAGE_TYPE>::getHash() const {
