...
namespace bw_music {
    ...
    class MUSICLIB_API PercussionMapProcessorInput : public babelwires::ParallelProcessorInputBase {
      public:
    ...
    class MUSICLIB_API PercussionMapProcessorOutput : public babelwires::ParallelProcessorOutputBase {
      public:
    ...
    class MUSICLIB_API PercussionMapProcessor : public babelwires::ParallelProcessor {
      public:
