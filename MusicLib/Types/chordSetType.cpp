...
bw_music::ChordSetType::ChordSetType()
...
bw_music::ChordSetType::getChordTypesFromValue(const babelwires::TypeSystem& typeSystem, const babelwires::ValueHolder& value) const {
