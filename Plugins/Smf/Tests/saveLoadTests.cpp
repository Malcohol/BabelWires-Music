...
namespace {
    bw_music::Track makeChannelVoiceCoverageTrack() {
        ...
        track.addEvent(bw_music::PanTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue32::assertFromUnsigned<32>(0u)));
        ...
        track.addEvent(bw_music::PitchBendTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue32::assertFromUnsigned<14>(0u)));
        ...
        track.addEvent(bw_music::PitchBendTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue32::assertFromUnsigned<14>(0x3fffu)));
