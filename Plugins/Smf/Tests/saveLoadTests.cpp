...
namespace {
    bw_music::Track makeChannelVoiceCoverageTrack() {
        ...
        track.addEvent(bw_music::PanTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue::fromUnsigned32(0)));
        ...
        track.addEvent(bw_music::PitchBendTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue::assertFromUnsigned<14>(0)));
        ...
        track.addEvent(bw_music::PitchBendTrackEvent(babelwires::Rational(1, 16), bw_music::MinCentredMaxValue::assertFromUnsigned<14>(0x3fff)));
